...
bodies = [
    MaterialPoint(u, 3500., vec([  0.,   0.]), vec([ 0.,   0.])),
...
for b in bodies:
    ...
    print("zip создает итератор, объединяюзий элементы b.trace, что эквивалентно значениям xs и ys, а map делает из них список. Тем не менее мы получаем генератор в качестве типа данных и matpotlib не принимает их на вход, поэтому tuple в свою очередь превращает свои аргумент в кортеж")
